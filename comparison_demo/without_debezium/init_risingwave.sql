...
FROM pg_source TABLE 'public.attendances';
...
FROM pg_source TABLE 'public.shift_schedule';
...
FROM pg_source TABLE 'public.shift_rules';
...
FROM pg_source TABLE 'public.master_unit_organization';
...
FROM pg_source TABLE 'public.user_grade';
...
FROM pg_source TABLE 'public.master_grade';
...
FROM pg_source TABLE 'public.user_position';
...
FROM pg_source TABLE 'public.master_position';
...
FROM pg_source TABLE 'public.master_position_type';
